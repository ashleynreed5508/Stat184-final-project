...
ChicagoCrimeOriginal %>%
  rename(id = ID, 
         ...
         long = Longitude,
         location = Location) %>%
  select(date, block, iucr, primary_type, description, location_description, arrest, domestic, beat, district, ward, community_area, fbi_code, year, lat, long, location) %>%
